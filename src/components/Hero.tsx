        ...
        <section className="min-h-screen bg-[#F5DDD1] pt-20 px-6">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-5xl md:text-7xl font-light text-[#1A4A47] tracking-[0.2em] mb-2">
                        FRANCHETTE
                    </h1>
                    <p className="text-[#1A4A47] text-lg tracking-widest">
                        /fran·shay/
                    </p>
                </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center gap-12 mt-16">
                    ...
                    <div className="lg:order-1">
                        <div className="bg-[#1A4A47] text-white px-6 py-4 font-bold text-lg">
                            <div>FULL-STACK</div>
                            <div>DEVELOPER</div>
                        </div>
                    </div>
