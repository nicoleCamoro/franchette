          ...
          <div className="lg:w-1/2">
            ...
            <div className="text-white text-base leading-relaxed space-y-4 font-inter">
              <p>
                ...
                responsive web apps throughout her tenure as Synph. Her code is
                clean. Her solutions are crisp. Her current goal balances
                technical excellence with business needs. Nicole specializes in
                responsive applications, seamless APIs, and sleek user
                interfaces that captivate. She tackles complex problems with
                simple solutions. Clients value her ability to translate
                technical concepts into business outcomes, and her talent for
                collaboration and mentorship are what make an impact.
              </p>
            </div>
          </div>
